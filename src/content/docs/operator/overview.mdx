...
This Dusk Node documentation documentation is for anyone interested in running a Dusk node. Here you can find information about the different types of nodes, the requirements for running a node, and the different ways to set up a node.
...
<CardGrid>
        <LinkCard title="Provisioner Node" href="/operator/provisioner" description="Run a provisioner node on Dusk and participate in consensus"/>
        <LinkCard title="Archive Node" href="/operator/archive-node" description="Run an archive node and store more detailed historical chain data"/>
