...
If you only want to stake or understand staking before operating infrastructure, start with: [Staking on Dusk](/learn/guides/staking-basics/).
...
For staking rules and reward timing, see [Staking on Dusk](/learn/guides/staking-basics/). For next steps after setup, see [Maintenance & monitoring](/operator/maintenance-monitoring/) and [Upgrade your node](/operator/guides/upgrade-node/).
