...
<CardGrid>
  ...
  <LinkCard
    ...
    href="/developer/duskds/overview"
...
If that’s you, start with the [native Dusk contract overview](/developer/duskds/overview/), then build the example in the [quickstart](/developer/duskds/quickstart/).
...
- The native contract framework and template in [Forge](https://github.com/dusk-network/forge)
