...
Dusk is privacy-preserving infrastructure for regulated onchain finance with selective disclosure. It is designed for workflows where issuers, venues, institutions, developers, and users need privacy, access controls, and deterministic settlement without putting sensitive market data on public display.
...
See: [Privacy on Dusk](/learn/privacy-on-dusk), [Cryptography](/learn/cryptography), and [Transaction Models on Dusk](/learn/deep-dive/duskds-tx-models).
...
See: [Core Components](/learn/core-components) and the [DuskEVM quickstart](/developer/duskevm/quickstart/).
...
| ---------- | ------------------------------------------------------------------ | ------------------------------------------- |
| **DuskDS** | Dusk Data Availability and Settlement layer: consensus, finality, data availability, and transaction models | [Core Components](/learn/core-components)   |
| **DuskVM** | Rust/WASM smart-contract execution directly on the Dusk L1 | [Build on DuskVM](/developer/duskvm/quickstart/) |
| **DuskEVM**| EVM execution environment where DUSK is the gas token              | [Build on DuskEVM](/developer/duskevm/quickstart/) |
...
<CardGrid>
  <LinkCard
    title="Use Dusk"
    href="/use/overview"
    description="Choose a wallet, manage DUSK, stake, bridge, and inspect network activity."
  />
  <LinkCard
    title="Stake DUSK"
  ...
  <LinkCard
    ...
    description="Explore DuskVM and DuskEVM developer docs and start building."
  />
</CardGrid>
